...
public class ProperPlateauTest extends AbstractMinMaxParameterizedTest {
	...
	public static Collection<Object[]> dataSet() {
		...
		return Arrays.asList(new Object[][] {
				...
				{ new Max(), new features.impl.Surface(), PATH_TO_PATTERN, PATH_TO_INPUT+"width_proper_plateau",Arrays.asList(new AutomatonResult(15, 12, 14)) },
				{ new Min(), new features.impl.Surface(), PATH_TO_PATTERN, PATH_TO_INPUT+"width_proper_plateau",Arrays.asList(new AutomatonResult(6, 2, 3))	 },
		});
