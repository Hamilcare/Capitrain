...
public class PeakTest extends AbstractMinMaxParameterizedTest {
	...
	public static Collection<Object[]> dataSet() {
		...
		return Arrays.asList(new Object[][] {
			...
			{ new Min(), new automaton.features.impl.Max(), RESOURCES_PATTERN_PEAK_CSV, RESOURCES_INPUT_CATALOGUE_EXEMPLES_PEAK, Arrays.asList(new AutomatonResult(3, 12, 14)) },
			{ new Max(), new automaton.features.impl.Max(), RESOURCES_PATTERN_PEAK_CSV, RESOURCES_INPUT_CATALOGUE_EXEMPLES_PEAK, Arrays.asList(new AutomatonResult(6, 8, 10))},
			{ new Max(), new automaton.features.impl.Surface(), RESOURCES_PATTERN_PEAK_CSV, RESOURCES_INPUT_CATALOGUE_EXEMPLES_PEAK, Arrays.asList(new AutomatonResult(14, 8, 10))},
			{ new Min(), new automaton.features.impl.Surface(), RESOURCES_PATTERN_PEAK_CSV, RESOURCES_INPUT_CATALOGUE_EXEMPLES_PEAK, Arrays.asList(new AutomatonResult(9, 4, 5	),new AutomatonResult(9, 12, 14))},
		});
		// @formatter:on
	}
